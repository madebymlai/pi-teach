...
export default function quiz(pi: ExtensionAPI) {
	pi.registerTool({
		...
		label: "quiz",
		description:
			"Ask one multiple-choice or multi-select question and grade the selection against the supplied correctAnswer, then reveal the explanation. Multi-select requires an exact-set match. Adds an 'I don't know' choice and an optional note field; notes are not graded as free-text answers.",
		promptSnippet: "Ask a graded multiple-choice or multi-select question.",
		promptGuidelines: [
			"Use quiz for answer selection; use ask_user_question without options for open-ended responses, including answers you will assess yourself.",
			"For quiz, supply only gradable options: the tool adds 'I don't know'. Treat dontKnow as a knowledge gap and use any returned note to guide follow-up.",
			"Make each quiz distractor a plausible, unambiguously wrong misconception; keep options comparable in length and specificity so formatting does not reveal the answer.",
		],
